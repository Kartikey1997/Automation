...
class LogGen:
    ...
    def loggen():
        ...
        '''if(day=="Mon"):
            fhandler = logging.FileHandler(filename="/home/admin7/Documents/Housekeeping_logs/Attendence-" + date + ".log",
                                           mode="a")'''
...
if(date in holiday_lst):
    ...
    driver.find_element_by_xpath("/html/body/div/div[3]/div[2]/div[3]/form/div[2]/input").send_keys("madras@.income")
    log.info("Password Entered Properly")
    driver.find_element_by_name("Login").click()
    log.info("Login Button Pressed")
    try:
        driver.find_element_by_xpath("//*[text()='Sorry! The Employee code or Password you entered is incorrect, Please go back and try again.']")
        ...
        try:
            ...
            time.sleep(1)
            txt = driver.find_element_by_xpath("/html/body/div[2]/div[6]/div[1]").text
            ...
            if("Welcome" in txt):
                ...
                txt2 = driver.find_element_by_xpath("/html/body/div[2]/table[3]").text
                print(txt2)
                log.info(txt2)
