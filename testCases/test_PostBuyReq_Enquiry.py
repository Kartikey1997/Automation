...
class Test_Enquiry4:
    ...
    product_name = ReadConfig.get_product_PostBuyReq()
    ...
    def test_004_RED_ButtonInquiry(self,setup):                  ############Always define a testcase function with its initials as "test"


        self.logger.info("Test_004_Post_Buy_RequirementInquiry ************")
        self.driver = setup
        ...
        if (revertmsg == "Thank You"):
            ...
            self.logger.info("============ Test_004_Post_Buy_RequirementInquiry, PASSED ============")
            assert True
        else:
            self.logger.info("============= Post Buy Requirement Inquiry not Submitted, screenshot generated ============")
            self.logger.info("============ Test_004_Post_Buy_RequirementInquiry, FAILED ============")
            timestr = datetime.now().strftime("%d-%m-%Y--%I:%M:%p")
