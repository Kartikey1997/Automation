...
class Test_Enquiry3:
    ...
    product_name = ReadConfig.get_product_ContactSupplier()
    ...
    def test_003_ContactSupplier_Inquiry(self,setup):                  ############Always define a testcase function with its initials as "test"


        self.logger.info("Test_007_ContactSupplier_Inquiry ************")
        self.driver = setup
        ...
        time.sleep(2)
        self.itemInquiry.requirementPageSubmitButton()
        ...
        if (revertmsg == "Thank you"):
            ...
            self.logger.info("============ Test_003_ContactSupplier_Inquiry, PASSED ============")
            assert True
        else:
            self.logger.info("============= Contact Supplier Inquiry not Submitted, screenshot generated ============")
            self.logger.info("============ Test_003_ContactSupplier_Inquiry, FAILED ============")
            timestr = datetime.now().strftime("%d-%m-%Y--%I:%M:%p")
