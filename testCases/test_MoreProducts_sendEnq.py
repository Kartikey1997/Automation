...
class Test_Enquiry1:
    ...
    def test_0012_MoreProductsFromThisSeller_Inquiry(self,setup):                  ############Always define a testcase function with its initials as "test"
        ...
        self.itemInquiry.sendEnquiry_moreProductsFromThisSeller()
        time.sleep(2)
        ...
        if (revertmsg == "Thank you"):
            ...
            self.logger.info("============ Test_0012_MoreProductsFromThisSeller_Inquiry, PASSED ============")
            assert True
        else:
