...
class Test_Enquiry2:
    ...
    product_name = ReadConfig.get_product_getLatestPrice()
    ...
    def test_002_GetLatestPrice_Inquiry(self,setup):                  ############Always define a testcase function with its initials as "test"


        self.logger.info("Test_002_GetLatestPrice_Inquiry ************")
        self.driver = setup
        ...
        if (revertmsg == "Thank you"):
            ...
            self.logger.info("============ Test_002_GetLatestPrice_Inquiry, PASSED ============")
            assert True
        else:
            self.logger.info("============= Get Latest Price Inquiry not Submitted, screenshot generated ============")
            self.logger.info("============ Test_002_GetLatestPrice_Inquiry, FAILED ============")
            timestr = datetime.now().strftime("%d-%m-%Y--%I:%M:%p")
