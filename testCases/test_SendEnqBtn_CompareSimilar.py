...
class Test_Enquiry6:
    ...
    product_name = ReadConfig.get_product_CompareSimilar()
    ...
    def test_006_SendEnqBtn_CompareSimilarProducts(self,setup):                  ############Always define a testcase function with its initials as "test"


        self.logger.info("Test_006_SendEnqBtn_CompareSimilarProducts ************")
        self.driver = setup
        ...
        if (revertmsg == "Thank You"):
            ...
            self.logger.info("============ Test_006_SendEnqBtn_CompareSimilarProducts, PASSED ============")
            assert True
        else:
            self.logger.info("============= Inquiry from Compare with Similar Products not Submitted, screenshot generated ============")
            self.logger.info("============ Test_006_SendEnqBtn_CompareSimilarProducts, FAILED ============")
            timestr = datetime.now().strftime("%d-%m-%Y--%I:%M:%p")
